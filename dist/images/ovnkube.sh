...
nb-ovsdb-etcd () {
  ...
  -cpu-profile=${nb_cpuprofile_file} -keepalive-time=6s -keepalive-timeout=20s -model=${ovsdb_etcd_model} &
...
sb-ovsdb-etcd () {
  ...
  -cpu-profile=${sb_cpuprofile_file} -keepalive-time=6s -keepalive-timeout=20s -model=${ovsdb_etcd_model} &
